...
//            boolean check= true;
//            Shooting(koeff,0.79);
//            goToPosition(-46* COUNTS_PER_INCH, -227*COUNTS_PER_INCH,0.3*koeff,0,2*COUNTS_PER_INCH);
//            angles=imu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES);
...
//                check=false;
//                goToPosition(-35* COUNTS_PER_INCH,-277* COUNTS_PER_INCH,0.3*koeff,0,2*COUNTS_PER_INCH);
...
//                }
//                setMotorsPower(0,0,0,0);
//                goToPosition(-30 * COUNTS_PER_INCH, -275 * COUNTS_PER_INCH, 0.3*koeff, 0, 3 * COUNTS_PER_INCH);
//
//            }
//            if(countOfRings==4&&check){//добавить координату
//                check=false;
//                goToPosition(-26* COUNTS_PER_INCH,-455*COUNTS_PER_INCH,0.3*koeff,0,2*COUNTS_PER_INCH);
//                angles=imu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES);
//                while(!isStopRequested()&&angles.firstAngle>-35){
//                    setMotorsPower(0.3*koeff,0.3*koeff,0.3*koeff,0.3*koeff);
//                    angles=imu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES);
...
//                }
//                setMotorsPower(0,0,0,0);
//                goToPosition(-30 * COUNTS_PER_INCH, -280 * COUNTS_PER_INCH, 0.3*koeff, 0, 3 * COUNTS_PER_INCH);
//
//            }
//            if(countOfRings==1&&check){//добавить координату
//                check=false;
//                goToPosition(-5* COUNTS_PER_INCH,-430*COUNTS_PER_INCH,0.3*koeff,0,2*COUNTS_PER_INCH);
//                angles=imu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES);
